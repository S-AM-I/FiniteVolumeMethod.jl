...
function apply_bc_left!(U::AbstractVector, ::ReflectiveBC, law::HallMHDEquations{1}, ncells::Int, ng::Int, t)
    for g in 1:ng
...
function apply_bc_right!(U::AbstractVector, ::ReflectiveBC, law::HallMHDEquations{1}, ncells::Int, ng::Int, t)
