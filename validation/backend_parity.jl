...
function _cuda_hyperbolic_2d_parity()
    ...
    coords_cpu, U_cpu, t_cpu = solve_hyperbolic(prob; method = :ssprk3, backend = CPUBackend())
    coords_gpu, U_gpu, t_gpu = solve_hyperbolic(prob; method = :ssprk3, backend = CUDASolverBackend())
