...
ode = sciml_problem(prob; vector_potential = Az_rotor)
...
You can view the source code for this file [here](https://github.com/cx-xd/FiniteVolumeMethod.jl/tree/main/docs/src/literate_hyperbolic/mhd_rotor.jl).
