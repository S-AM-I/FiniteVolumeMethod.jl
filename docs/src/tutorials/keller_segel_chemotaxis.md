...
This example is intentionally marked as documentation-only metadata in CI:
it remains part of the published tutorial set, but because of its runtime and
...
You can view the source code for this file [here](https://github.com/cx-xd/FiniteVolumeMethod.jl/tree/main/docs/src/literate_tutorials/keller_segel_chemotaxis.jl).
