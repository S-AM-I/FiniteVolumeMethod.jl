...
const TESTS = [
    ...
    ("governance", "Collocated Assembly Benchmark (Stage 1a-c)", "governance/assembly_bench.jl"),
    ("sciml", "SciML Contract Uniform (Stage 1d)", "sciml/sciml_contract_uniform.jl"),
    ("experimental", "MPI Partition (Stage 2)", "experimental/mpi_partition.jl"),
    ("experimental", "Pressure-Based Thermo + Rheology (Stage 3)", "experimental/pressure_based_models.jl"),
    ("collocated", "Turbulence Correctness (Stage 4)", "collocated/turbulence_correctness.jl"),
    ("collocated", "Phase Correctness (Stage 5)", "collocated/stage5_correctness.jl"),
    ("collocated", "Industrial Physics (Stage 6)", "collocated/stage6_physics.jl"),
    ("collocated", "Coupled Physics (Stage 7)", "collocated/stage7_coupled.jl"),
    ("collocated", "Meshing + AMR (Stage 8)", "collocated/stage8_meshing_amr.jl"),
    ("sciml", "SciML Deep Integration (Stage 9)", "sciml/stage9_sciml.jl"),
